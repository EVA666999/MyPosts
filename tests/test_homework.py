...
class TestPost:
    def test_post_model(self):
        ...
        assert isinstance(
            pub_date_field, fields.DateTimeField
        ...
        assert isinstance(
            author_field, fields.related.ForeignKey
        ...
        assert isinstance(
            group_field, fields.related.ForeignKey
        ...
        assert isinstance(
            image_field, fields.files.ImageField
...
class TestGroup:
    def test_group_model(self):
        ...
        assert isinstance(
            description_field, fields.TextField
